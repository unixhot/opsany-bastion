    ...
    <div class="passwordDetails_main">
        ...
        <div class="content">
            ...
            <a-tabs type="card">
                ...
                <a-button v-if="$store.state.btnAuth.btnAuth.bastion_password_resource_create" @click="$refs.AssociatedResources.show(credentialInfo)" type="primary" slot="tabBarExtraContent">关联资源</a-button>
            </a-tabs>
            <a-table style="padding:20px" :columns="columns" :data-source="tableData">
                <template slot="action" slot-scope="text,record">
                    <a v-if="$store.state.btnAuth.btnAuth.bastion_password_resource_delete" @click="remove(record)">移除</a>
                </template>
            </a-table>
        </div>
