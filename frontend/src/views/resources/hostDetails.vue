<template>
    <div class="hostDetails_main">
        ...
        <div class="content">
            ...
            <div class="relation">
                <a-menu :selectedKeys="selectedKeys" @select="voucherTypeChange" class="left" mode="inline">
                    <a-menu-item key="password">密码凭证</a-menu-item>
                    <a-menu-item key="ssh">SSH密钥</a-menu-item>
                    <a-menu-item key="group">凭证分组</a-menu-item>
                </a-menu>
                <a-table class="right" style="padding:20px" :columns="columns" :data-source="tableData">
